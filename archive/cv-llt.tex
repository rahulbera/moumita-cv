...
\leftheader{%
  {\LARGE\bfseries\sffamily Moumita Dey}

  \makefield{\faEnvelope[regular]}{\href{mailto:reachmoumita.93@gmail.com}{\texttt{reachmoumita.93@gmail.com}}}
  ...
  {\href{https://www.linkedin.com/in/moumita-dey-6980b09b/}{\texttt{LinkedIn: Moumita Dey}}}

  %% Next line
  % \makefield{\faGlobe}{\url{http://example.example.org/}}
  \makefield{\faCheckSquare}{\texttt{Swiss B-permit holder}}
